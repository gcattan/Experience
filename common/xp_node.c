...
xp_node *xp_node_get_brother(xp_node *a_child, int a_pos)
{
    xp_node *node = a_child->parent;
    return bind(node)->get_child_at(a_child->index_in_parent + a_pos);
}
